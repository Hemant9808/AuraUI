const buttonData = [
  {
    ...
    code: `<button>
  <a href="#" class="group aura-ocean-gradient hover:aura-ocean-gradient px-8 py-2 rounded-md text-white inline-flex items-center justify-center overflow-hidden">Hover Me</a>
</button>`,
  },
  {
    id: 'aura_call',
    ...
    code: `<button>
  <a href="#" class="group aura-ocean-gradient hover:aura-ocean-gradient px-8 py-2 rounded-md text-white inline-flex items-center justify-center overflow-hidden">
    <span>
  ...
  },
  {
    ...
    code: `<button>
  <a href="#" class="group aura-ocean-gradient hover:aura-ocean-gradient px-10 py-2 rounded-md text-white inline-flex items-center justify-center overflow-hidden transition-all duration-200">
  ...
  },
  {
    ...
    code: `<button>
  <a href="#" class="aura-ocean-gradient-animate hover:aura-ocean-gradient px-8 py-2 rounded-md text-white inline-flex items-center justify-center overflow-hidden">Hover Me</a>
</button>`,
  },
];
