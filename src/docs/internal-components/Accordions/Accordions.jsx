  ...
  return (
    ...
    >
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-6'>
        ...
        <h3 className='text-xl sm:text-2xl font-semibold mb-2'>Aura Accordion Panel</h3>
        <p className='mb-10 sm:mb-16'>
        AuraUI's accordion component organizes content into expandable sections with smooth transitions, paired with a complementary visual for enhanced engagement.
        </p>
